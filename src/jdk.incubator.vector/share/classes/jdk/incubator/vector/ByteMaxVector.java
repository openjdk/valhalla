...
value class ByteMaxVector extends ByteVector {
    ...
    static final ByteMaxVector ZERO = new ByteMaxVector(createPayloadInstance(VSPECIES));
    ...
    static final value class ByteMaxMask extends AbstractMask<Byte> {
        ...
        static final long MFOFFSET = VectorPayloadMF.multiFieldOffset(VectorPayloadMFMaxBZ.class);
    ...
    static final value class ByteMaxShuffle extends AbstractShuffle<Byte> {
        ...
        ByteVector toBitsVector0() {
            return ByteMaxVector.VSPECIES.dummyVectorMF().vectorFactory(indices());
        }
