...
value class Byte256Vector extends ByteVector {
    ...
    static final Byte256Vector ZERO = new Byte256Vector(createPayloadInstance(VSPECIES));

    static final Byte256Vector IOTA = new Byte256Vector(VectorPayloadMF.createVectPayloadInstanceB(32, (byte[])(VSPECIES.iotaArray()), false));
    ...
    static final value class Byte256Mask extends AbstractMask<Byte> {
        ...
        static final long MFOFFSET = VectorPayloadMF.multiFieldOffset(VectorPayloadMF256Z.class);
