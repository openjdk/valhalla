...
value class Double512Vector extends DoubleVector {
    ...
    static final Double512Vector ZERO = new Double512Vector(createPayloadInstance(VSPECIES));

    static final Double512Vector IOTA = new Double512Vector(VectorPayloadMF.createVectPayloadInstanceD(8, (double[])(VSPECIES.iotaArray()), false));
