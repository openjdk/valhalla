    ...
    void writeStackMap(Code code) {
        ...
        void writeStackMapType(Type t) {
            ...
            case ARRAY:
                ...
                databuf.appendChar(emitQDesc && t.isValueClassWithImplicitConstructor() ? poolWriter.putClass(new ConstantPoolQType(types.erasure(t), types)) : poolWriter.putClass(types.erasure(t)));
                break;
            case TYPEVAR:
                if (debugstackmap) System.out.print("object(" + types.erasure(t).tsym + ")");
                databuf.appendByte(7);
