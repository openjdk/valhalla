...
#define VM_STRUCTS(nonstatic_field, static_field, unchecked_nonstatic_field, volatile_nonstatic_field) \
  ...
  nonstatic_field(ArrayKlass,                  ArrayKlass::_properties,                       ArrayKlass::ArrayProperties const)     \
...
#define VM_INT_CONSTANTS(declare_constant, declare_constant_with_value, declare_preprocessor_constant) \
  ...
  declare_constant(ArrayKlass::INVALID)                                   \
  declare_constant(ArrayKlass::NON_ATOMIC)                                \
  declare_constant(ArrayKlass::NULL_RESTRICTED)                           \
