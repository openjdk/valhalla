...
void VM_RedefineClasses::set_new_constant_pool(
  ...
  if (update_required) {
    ...
    Array<u1>* new_fis = FieldInfoStream::create_FieldInfoStream(fields, java_fields, injected_fields, scratch_class->class_loader_data(),
                                                                 scratch_class->multifield_info(), CHECK);
    ...
    Array<u1>* search_table = FieldInfoStream::create_search_table(scratch_class->constants(), new_fis, scratch_class->class_loader_data(),
                                                                   scratch_class->multifield_info(), CHECK);
    ...
    DEBUG_ONLY(FieldInfoStream::validate_search_table(scratch_class->constants(), new_fis, search_table, scratch_class->multifield_info()));
  }
