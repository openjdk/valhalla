...
class FieldStreamBase : public StackObj {
 ...
 protected:
  ...
  inline FieldStreamBase(const Array<u1>* fieldinfo_stream, ConstantPool* constants, Array<MultiFieldInfo>* multifield_info);
 ...
 public:
  ...
  Symbol* name() const {
    return field()->name(_constants(), _multifield_info);
  }
  ...
  fieldDescriptor& field_descriptor() const {
    ...
    field.reinitialize(field_holder(), to_FieldInfo(), _multifield_info);
    return field;
  }
};
