...
class ResolvedFieldEntry {
  ...
  u1 _flags;                    // Flags: [000|has_null_marker|is_null_checked|is_flat|is_final|is_volatile]
...
public:
  ...
  bool is_null_checked()          const { return (_flags & (1 << is_null_checked_shift)) != 0; }
  ...
  void set_flags(bool is_volatile_flag,
    ...
    int new_flags =
        ...
        ((is_null_checked_flag ? 1 : 0) << is_null_checked_shift) |
    ...
    assert(is_null_checked() == is_null_checked_flag, "Must be");
