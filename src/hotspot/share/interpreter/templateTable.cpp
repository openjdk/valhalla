...
void TemplateTable::initialize() {
  ...
  def(Bytecodes::_fast_qgetfield      , ubcp|____|____|____, atos, atos, fast_accessfield    ,  atos        );
  ...
  def(Bytecodes::_fast_qputfield      , ubcp|____|____|____, atos, vtos, fast_storefield ,   atos        );
