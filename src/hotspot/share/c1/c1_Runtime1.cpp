...
int Runtime1::_load_flat_array_slowcase_cnt = 0;
int Runtime1::_store_flat_array_slowcase_cnt = 0;
...
void Runtime1::print_statistics() {
  ...
  tty->print_cr(" _load_flat_array_slowcase_cnt:   %d", _load_flat_array_slowcase_cnt);
  tty->print_cr(" _store_flat_array_slowcase_cnt:  %d", _store_flat_array_slowcase_cnt);
