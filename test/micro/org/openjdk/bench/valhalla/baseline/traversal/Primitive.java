...
public abstract class Primitive extends TraversalBase {
    ...
    public static int walk(int[] a) {
        int steps = 0;
        for(int i = a[0]; i!=0; i=a[i]) steps++;
        return steps;
    }

    public static class W0001 extends Primitive {
    ...
    public static class W0004 extends Primitive {
    ...
    public static class W0016 extends Primitive {
    ...
    public static class W0032 extends Primitive {
    ...
    public static class W0128 extends Primitive {
    ...
    public static class W0256 extends Primitive {
    ...
    public static class W1024 extends Primitive {
