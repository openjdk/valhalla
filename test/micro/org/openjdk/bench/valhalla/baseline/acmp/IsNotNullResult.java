 ...
 *  java -jar target/benchmarks.jar baseline.acmp.IsNotNullResult -wmb baseline.acmp.IsNotCmpBranch.equals050
 */
@Fork(3)
...
@State(Scope.Thread)
public class IsNotNullResult extends ACmpBase {
    ...
    private static boolean comparison(Object[] objects1) {
        boolean s = false;
