 ...
 *  java -jar target/benchmarks.jar baseline.acmp.IsNotCmpBranch -wmb baseline.acmp.IsNotCmpBranch.equals050
 */
@Fork(3)
...
@State(Scope.Thread)
public class IsNotCmpBranch extends ACmpBase {
    ...
    private static int comparison(Object[] objects1, Object[] objects2) {
        int s = 0;
