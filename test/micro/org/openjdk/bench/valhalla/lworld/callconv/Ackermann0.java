...
public class Ackermann0 extends AckermannBase {
    ...
    public static inline class PairExact {
        final int x;
        final int y;
    ...
    public static inline class PairExactWithField {
        final int x;
        final int y;

        public PairExactWithField(int x, int y) {
            this.x = x;
            this.y = y;
        }
        ...
        public PairExactWithField cross(PairExactWithField o) {
            return __WithField(this.y, o.y);
        }

        private PairExactWithField decX() {
            return __WithField(this.x, x - 1);
        }

        private PairExactWithField decY() {
            return __WithField(this.y, y - 1);
        }

        private PairExactWithField incX() {
            return __WithField(this.x, x + 1);
        }

        private PairExactWithField incY() {
            return __WithField(this.y, y + 1);
        }
    }
    ...
    public static inline class PairImpl1 implements Pair {
        final int x;
        final int y;
    ...
    public static inline class PairImpl2 implements Pair {
        final int x;
        final int y;
    ...
    public static inline class PairImpl3 implements Pair {
        final int x;
        final int y;
    ...
    public static PairExactWithField ackermannExactTypeWithField(PairExactWithField arg) {
        if (arg.getX() == 0) {
            return arg.incY();
        } else if (arg.getY() == 0) {
            return ackermannExactTypeWithField(arg.decX().incY());
        } else {
            return ackermannExactTypeWithField(arg.decX().cross(ackermannExactTypeWithField(arg.decY())));
        }
    }
    ...
    @Benchmark
    @OperationsPerInvocation(OPI)
    public int valueWithField() {
        return ackermannExactTypeWithField(new PairExactWithField(X1, Y1)).getY()
                + ackermannExactTypeWithField(new PairExactWithField(X2, Y2)).getY()
                + ackermannExactTypeWithField(new PairExactWithField(X3, Y3)).getY();
    }
