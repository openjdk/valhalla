...
public class Inline64long {
    ...
    // must be divisible by 2 and 3 and around 100
    ...
    public long Q64long_args4_targets0(StateTargets0 st) {
        ...
        for (InvocationLogic t : arr) {
            Q64long a0 = new Q64long(r);
            Q64long a1 = new Q64long(r+1);
            Q64long a2 = new Q64long(r+2);
            Q64long a3 = new Q64long(r+3);
            r += t.compute(a0, a1, a2, a3).longValue();
        }
        return r;
    }
    ...
    public long Q64long_args8_targets0(StateTargets0 st) {
        ...
        for (InvocationLogic t : arr) {
            ...
            Q64long a2 = new Q64long(r+2);
            Q64long a3 = new Q64long(r+3);
            Q64long a4 = new Q64long(r+4);
            Q64long a5 = new Q64long(r+5);
            Q64long a6 = new Q64long(r+6);
            Q64long a7 = new Q64long(r+7);
            r += t.compute(a0, a1, a2, a3, a4, a5, a6, a7).longValue();
        }
        return r;
    }
