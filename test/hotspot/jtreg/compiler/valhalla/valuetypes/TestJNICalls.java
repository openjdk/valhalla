 ...
 * @compile -XDallowWithFieldOperator TestJNICalls.java
 ...
 *                               compiler.valhalla.valuetypes.TestJNICalls
 */
public class TestJNICalls extends ValueTypeTest {
    ...
    // Pass a value type to a native method that calls back into Java code and returns a value
    @Test
    ...
    // Pass a value type to a native method that calls the hash method and returns the result
    @Test
    @Warmup(10000) // Make sure native method is compiled
    ...
    // Call a native method with a value type receiver
    @Test
    @Warmup(10000) // Make sure native method is compiled
