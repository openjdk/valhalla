...
public class resume001a {
    ...
    private static Threadresume001a thread2 = null;
    private static Threadresume001a thread3 = null;
    private static Threadresume001a thread4 = null;
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         thread2 = new
                              Threadresume001a(threadGroup2Obj, "Thread2");
                         log1("       thread2 is created");
                         thread3 = new
                              Threadresume001a(threadGroup3Obj, "Thread3");
                         log1("       thread3 is created");
                         thread4 = new
                              Threadresume001a(threadGroup4Obj, "Thread4");
                         log1("       thread4 is created");

                         label:
                         synchronized (Threadresume001a.lockingObject) {
                             synchronized (Threadresume001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadresume001a.waitnotifyObj.wait();
...
class Threadresume001a extends Thread {
    ...
    public Threadresume001a(ThreadGroup groupName, String threadName) {
