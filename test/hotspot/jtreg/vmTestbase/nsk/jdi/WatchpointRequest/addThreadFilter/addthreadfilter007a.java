...
/**
 * This class is used as debuggee application for the addthreadfilter007 JDI test.
 */

public class addthreadfilter007a {
    ...
    static addthreadfilter007aTestClass objTC = new addthreadfilter007aTestClass();
    ...
    static class Threadaddthreadfilter007a extends NamedTask {

        int tNumber;

        public Threadaddthreadfilter007a(String threadName) {
            super(threadName);
            tNumber = number;
            number++;
...
class addthreadfilter007aTestClass {
