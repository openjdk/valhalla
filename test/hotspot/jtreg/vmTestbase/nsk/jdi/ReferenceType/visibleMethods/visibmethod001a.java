...
//                ("**> visibmethod001a: load class: Throwable thrown = " + thrown.toString());
        ...
        System.err.println("!!**> visibmethod001a: FAILED!");
        System.exit(2/*STATUS_FAILED*/ + 95/*STATUS_TEMP*/);
    }
}

abstract class visibmethod001aClassForCheck extends visibmethod001aSuperClassForCheck
    implements visibmethod001aInterfaceForCheck {
...
abstract class visibmethod001aSuperClassForCheck  {
...
interface visibmethod001aInterfaceForCheck {
