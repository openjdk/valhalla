...
public class thread001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadthread001a.lockingObject) {
                             synchronized (Threadthread001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadthread001a.waitnotifyObj.wait();
...
class Threadthread001a extends NamedTask {

    public Threadthread001a(String threadName) {
        super(threadName);
    }
