...
public class location001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadlocation001a.lockingObject) {
                             synchronized (Threadlocation001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadlocation001a.waitnotifyObj.wait();
...
class Threadlocation001a extends NamedTask {
