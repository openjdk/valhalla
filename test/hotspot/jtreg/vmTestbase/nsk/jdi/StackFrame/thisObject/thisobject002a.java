...
/**
 * This class is used as debuggee application for the thisobject002 JDI test.
 */

public class thisobject002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadthisobject002a.lockingObject) {
                             synchronized (Threadthisobject002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadthisobject002a.waitnotifyObj.wait();
...
//    public static final int breakpointLineNumber3 = 7;
    ...
    static void log(String str) {
        thisobject002a.log2("thread2: " + str);
    }
