...
public class typename002a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> typename002a: " + message);
    }
    ...
    static typename002aTestClass obj = new typename002aTestClass();
...
class typename002aTestClass {

    public  void testmethod (int param) {

        typename002aClassForCheck_2   class2 = new typename002aClassForCheck_2();
        typename002aInterfaceForCheck iface  = class2;
        typename002aClassForCheck     cfc[]  = { new typename002aClassForCheck(), new typename002aClassForCheck() };
...
class typename002aClassForCheck_2 implements typename002aInterfaceForCheck {
}

class typename002aClassForCheck {
