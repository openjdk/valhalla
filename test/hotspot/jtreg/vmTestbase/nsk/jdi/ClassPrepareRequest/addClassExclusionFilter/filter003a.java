...
//    static Thread1filter003a thread1 = null;
    ...
    //------------------------------------------------------  section tested
                    ...
                    case 0:
//                          thread1 = new Thread1filter003a("thread1");
//                          break;
...
/*
class Thread1filter003a extends Thread {
    ...
    public Thread1filter003a(String threadName) {
        super(threadName);
        tName = threadName;
    }

    public void run() {
        filter003a.log1("  'run': enter  :: threadName == " + tName);
        TestClass11 obj1 = new TestClass11();
        filter003a.log1("  'run': exit   :: threadName == " + tName);
        return;
    }
}
*/
