...
public class hashcode001a {
    ...
    //------------------------------------------------------  section tested
                 ...
                 case 0:
                         ...
                         label:
                         synchronized (Threadhashcode001a.lockingObject) {
                             synchronized (Threadhashcode001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadhashcode001a.waitnotifyObj.wait();
