...
/**
 * This class is used as debuggee application for the setvalue004 JDI test.
 */

public class setvalue004a {
    ...
    static    double  db1 = 0.0d,  db2 = 1.0d;
    static    float   fl1 = 0.0f,  fl2 = 1.0f;
    static    int     in1 = 0,     in2 = 1;
    static    long    ln1 = 0,     ln2 = 1;
