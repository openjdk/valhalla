...
public class referencetype003a {
    ...
    private static ThreadGroup mainGroupObj = new ThreadGroup("mainthreadGroupName");
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         Threadreferencetype003a test_thread =
                             new Threadreferencetype003a("testedThread");
                         log1("       thread2 is created");

                         label:
                         synchronized (Threadreferencetype003a.lockingObject) {
                             synchronized (Threadreferencetype003a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadreferencetype003a.waitnotifyObj.wait();
...
class Threadreferencetype003a extends Thread {
    ...
    private static ThreadGroup thread2GroupObj = null;

    private int i1 = 0, i2 = 10;

    public void run() {
        log("method 'run' enter");
        thread2GroupObj = new ThreadGroup("thread2GroupName");
