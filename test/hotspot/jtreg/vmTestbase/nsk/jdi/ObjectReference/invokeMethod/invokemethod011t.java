...
public class invokemethod011t {
    ...
    private int runIt(String args[]) {
        ...
        invokemethod011tDummyClass invokemethod011tdummyCls =
            new invokemethod011tDummyClass();

        log = argHandler.createDebugeeLog();
        pipe = argHandler.createDebugeeIOPipe();

        Thread.currentThread().setName(invokemethod011.DEBUGGEE_THRDS[0]);
 ...
 * in the debugger.
 */
class invokemethod011tDummyClass {
