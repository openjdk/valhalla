...
/**
 * This class is used as debuggee application for the componenttype001 JDI test.
 */

public class componenttype001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> componenttype001a: " + message);
    }
