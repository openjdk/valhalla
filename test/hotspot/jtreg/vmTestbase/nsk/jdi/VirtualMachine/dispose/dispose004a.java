...
/**
 * This class is used as debuggee application for the dispose004 JDI test.
 */

public class dispose004a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> dispose004a: " + message);
    }
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threaddispose004a.lockingObject) {
                             synchronized (Threaddispose004a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threaddispose004a.waitnotifyObj.wait();
