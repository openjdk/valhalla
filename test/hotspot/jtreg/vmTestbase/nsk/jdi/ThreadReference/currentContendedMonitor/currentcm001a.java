...
/*
                case 1:
                     ...
                     label: {
                         ...
                         synchronized (Threadcurrentcm001a.lockingObject) {
                             synchronized (Threadcurrentcm001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadcurrentcm001a.waitnotifyObj.wait();
...
class Threadcurrentcm001a extends JDITask {
    ...
    public Threadcurrentcm001a(ThreadGroup groupName, String threadName) {
