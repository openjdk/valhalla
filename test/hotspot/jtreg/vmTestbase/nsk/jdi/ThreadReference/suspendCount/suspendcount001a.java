...
public class suspendcount001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadsuspendcount001a.lockingObject) {
                             synchronized (Threadsuspendcount001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadsuspendcount001a.waitnotifyObj.wait();
...
//        log("returned from the method 'runt1'");
    ...
    void log(String str) {
        suspendcount001a.log2("thread2: " + str);
    }
