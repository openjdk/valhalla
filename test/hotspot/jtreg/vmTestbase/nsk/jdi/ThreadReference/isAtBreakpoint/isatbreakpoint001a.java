...
/**
 * This class is used as debuggee application for the isatbreakpoint001 JDI test.
 */

public class isatbreakpoint001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadisatbreakpoint001a.lockingObject) {
                             synchronized (Threadisatbreakpoint001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadisatbreakpoint001a.waitnotifyObj.wait();
...
class Threadisatbreakpoint001a extends NamedTask {
    ...
    void log(String str) {
        isatbreakpoint001a.log2("thread2: " + str);
    }
