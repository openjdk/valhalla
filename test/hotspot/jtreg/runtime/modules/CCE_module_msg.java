...
public class CCE_module_msg {
    ...
    public static void invalidObjectToDerived() {
        ...
        try {
            ...
            if (!cce.getMessage().contains("class java.util.Objects$ObjectWithIdentity cannot be cast to class Derived (java.util.Objects$ObjectWithIdentity is in module java.base of loader 'bootstrap'; Derived is in unnamed module of loader 'app')")) {
