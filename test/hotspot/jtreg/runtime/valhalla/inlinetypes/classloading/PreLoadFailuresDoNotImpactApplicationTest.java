 ...
 * @enablePreview
 * @run main PreLoadFailuresDoNotImpactApplicationTest
 */

public class PreLoadFailuresDoNotImpactApplicationTest {
  ...
  public static void main(String[] args) {
    try {
      ...
      throw new RuntimeException("test bug: running of threads", e);
    }
  }
  ...
  public static class CL extends ClassLoader {
    ...
    public Class<?> loadClass(String name) throws ClassNotFoundException {
      return loadClass(name, false); // Semantically equivalent according to jdoc.
    }
    ...
    private Class<?> customLoadSimple(String name) {
      byte[] bytes;
      try {
        bytes = PreLoadFailuresDoNotImpactApplicationTest.class.getClassLoader()
