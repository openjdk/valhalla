 ...
 * questions.
 */
package oracle.micro.valhalla.lword.util;
 ...
 */
public class HashMapValueTotal<K, V> extends AbstractMap<K, V> {

    Entry<K, V>[] table;

    public HashMapValueTotal(int initialCapacity) {
        super();
    ...
    __ByValue  public static final class EntryCursor<K,V> implements Cursor<Map.Entry<K,V>> {
        ...
        public static <K,V> EntryCursor<K,V> of(HashMapValueTotal<K,V> map) {
            if (map.size > 0) { // advance to first entry
                return of(map, map.modCount, getFilledSlot(map.table, 0), null);
            } else {
                return of(map, map.modCount, map.table.length, null);
            }
        }
        ...
        public EntryCursor<K, V> nextEntry() {
            ...
            if (next != null) {
                return of(map, expectedModCount, index, next);
            } else {
                return of(map, expectedModCount, getFilledSlot(t, index + 1), null);
            }
        }
    }
    ...
    __ByValue  public static final class KeyCursor<K,V> implements Cursor<K> {
        ...
        public static <K,V> KeyCursor<K,V> of(HashMapValueTotal<K,V> map) {
            if (map.size > 0) { // advance to first entry
                return of(map, map.modCount, getFilledSlot(map.table, 0), null);
            } else {
                return of(map, map.modCount, map.table.length, null);
