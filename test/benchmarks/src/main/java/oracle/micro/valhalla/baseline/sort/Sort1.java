...
public class Sort1 extends SortBase {
    ...
    public Box1[] makeRandomArray() {
        Box1[] arr = new Box1[size];
        for (int i = 0; i < size; i++) {
            arr[i] = new Box1 (ThreadLocalRandom.current().nextInt());
        }
        return arr;
    }

    @Benchmark
    public Box1[] quicksort() {
        Box1[] toSort = makeRandomArray();
        sort1(toSort, 0, toSort.length);
        return toSort;
    }

    @Benchmark
    public Box1[] mergeSort() {
        Box1[] toSort = makeRandomArray();
        Box1[] aux = new Box1[toSort.length];
    ...
    private static int compare(Box1 a, Box1 b) {
    ...
    private static void sort1(Box1 x[], int off, int len) {
     ...
     * Swaps x[a] with x[b].
     */
    private static void swap(Box1 x[], int a, int b) {
        Box1 t = x[a];
        x[a] = x[b];
        x[b] = t;
    }
     ...
     */
    private static void vecswap(Box1 x[], int a, int b, int n) {
     ...
     */
    private static int med3(Box1 x[], int a, int b, int c) {
    ...
    private static void mergeSort(Box1[] src,
                                  Box1[] dest,
