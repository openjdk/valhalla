...
public class Sort8 extends SortBase {
    ...
    public Box8[] makeRandomArray() {
        Box8[] arr = new Box8[size];
    ...
    @Benchmark
    public Box8[] quicksort() {
        Box8[] toSort = makeRandomArray();
        sort1(toSort, 0, toSort.length);
        return toSort;
    }

    @Benchmark
    public Box8[] mergeSort() {
        Box8[] toSort = makeRandomArray();
        Box8[] aux = new Box8[toSort.length];
    ...
    private static int compare(Box8 a, Box8 b) {
    ...
    private static void sort1(Box8 x[], int off, int len) {
     ...
     * Swaps x[a] with x[b].
     */
    private static void swap(Box8 x[], int a, int b) {
        Box8 t = x[a];
        x[a] = x[b];
        x[b] = t;
    }
     ...
     */
    private static void vecswap(Box8 x[], int a, int b, int n) {
     ...
     */
    private static int med3(Box8 x[], int a, int b, int c) {
    ...
    private static void mergeSort(Box8[] src,
                                  Box8[] dest,
